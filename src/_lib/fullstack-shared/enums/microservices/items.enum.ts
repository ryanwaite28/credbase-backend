export enum ItemsQueueMessageTypes {
  ...
  FETCH_ITEMS_BY_USER_ID = "FETCH_ITEMS_BY_USER_ID",
  FETCH_ITEMS_BY_USER_ID_PAGINATE = "FETCH_ITEMS_BY_USER_ID_PAGINATE",
...
export enum ItemsQueueEventTypes {
  ...
  FETCHED_ITEMS_BY_USER_ID = "FETCHED_ITEMS_BY_USER_ID",
  FETCHED_ITEMS_BY_USER_ID_PAGINATE = "FETCHED_ITEMS_BY_USER_ID_PAGINATE",
